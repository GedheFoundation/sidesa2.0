...
[wxID_KEJADIAN_KEMATIAN, wxID_KEJADIAN_KEMATIANBUTTON1, 
 wxID_KEJADIAN_KEMATIANCEK_AKTA_CERAI, 
 wxID_KEJADIAN_KEMATIANCEK_AKTA_KEMATIAN, 
 wxID_KEJADIAN_KEMATIANCEK_AKTA_LAHIR, wxID_KEJADIAN_KEMATIANCEK_AKTA_NIKAH, 
 wxID_KEJADIAN_KEMATIANCEK_KITAS, wxID_KEJADIAN_KEMATIANCEK_KTP, 
 wxID_KEJADIAN_KEMATIANCEK_PASPORT, wxID_KEJADIAN_KEMATIANCEK_VISA, 
 wxID_KEJADIAN_KEMATIANDAFTAR, wxID_KEJADIAN_KEMATIANDATEPICKERCTRL1, 
 ...
 wxID_KEJADIAN_KEMATIANINPUT_NIK, wxID_KEJADIAN_KEMATIANINPUT_NO_KK, 
 wxID_KEJADIAN_KEMATIANINPUT_TEMPAT_LAHIR, 
 wxID_KEJADIAN_KEMATIANKEJADIAN_KEMATIAN, wxID_KEJADIAN_KEMATIANKEMBALI, 
 wxID_KEJADIAN_KEMATIANLABEL_AGAMA, wxID_KEJADIAN_KEMATIANLABEL_ALAMAT, 
 ...
 wxID_KEJADIAN_KEMATIANLABEL_TEMPAT_LAHIR, wxID_KEJADIAN_KEMATIANLEBEL_NIK, 
 wxID_KEJADIAN_KEMATIANPETUGAS_KEMATIAN, wxID_KEJADIAN_KEMATIANPHOTO, 
 wxID_KEJADIAN_KEMATIANPILIHAN_AGAMA, 
 ...
 wxID_KEJADIAN_KEMATIANPILIHAN_WARGANEGARA, wxID_KEJADIAN_KEMATIANPILIHPHOTO, 
 wxID_KEJADIAN_KEMATIANSTATICTEXT1, wxID_KEJADIAN_KEMATIANSTATICTEXT2, 
 wxID_KEJADIAN_KEMATIANSTATICTEXT3, wxID_KEJADIAN_KEMATIANSTATICTEXT4, 
 wxID_KEJADIAN_KEMATIANTANGGAL_LAHIR, wxID_KEJADIAN_KEMATIANTEXTCTRL1, 
 wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_DATA, 
 wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_KEMBALI, 
] = [wx.NewId() for _init_ctrls in range(74)]

class kejadian_kematian(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_KEJADIAN_KEMATIAN,
              name=u'kejadian_kematian', parent=prnt, pos=wx.Point(300, 64),
              size=wx.Size(888, 639), style=wx.FRAME_NO_TASKBAR,
              title=u'Peristiwa Kematian Penduduk')
        ...
        self.photo = wx.StaticBitmap(bitmap=wx.Bitmap('/opt/sidesa/png/photo.png',
              wx.BITMAP_TYPE_PNG), id=wxID_KEJADIAN_KEMATIANPHOTO,
              name=u'photo', parent=self, pos=wx.Point(16, 200),
              size=wx.Size(110, 140), style=0)

        self.pilihphoto = wx.FilePickerCtrl(id=wxID_KEJADIAN_KEMATIANPILIHPHOTO,
        ...
        self.pilihan_warganegara = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANPILIHAN_WARGANEGARA,
        ...
        self.tombol_tambah_kembali = wx.Button(id=wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_KEMBALI,
        ...
        self.tombol_tambah_kembali.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_KEJADIAN_KEMATIANTOMBOL_TAMBAH_KEMBALI)
        ...
        self.cek_akta_lahir = wx.CheckBox(id=wxID_KEJADIAN_KEMATIANCEK_AKTA_LAHIR,
        ...
        self.cek_akta_nikah = wx.CheckBox(id=wxID_KEJADIAN_KEMATIANCEK_AKTA_NIKAH,
        ...
        self.cek_akta_cerai = wx.CheckBox(id=wxID_KEJADIAN_KEMATIANCEK_AKTA_CERAI,
        ...
        self.cek_akta_kematian = wx.CheckBox(id=wxID_KEJADIAN_KEMATIANCEK_AKTA_KEMATIAN,
        ...
        self.cek_ktp = wx.CheckBox(id=wxID_KEJADIAN_KEMATIANCEK_KTP,
        ...
        self.label_data_penduduk = wx.StaticText(id=wxID_KEJADIAN_KEMATIANLABEL_DATA_PENDUDUK,
              label=u'FORM DATA PERISTIWA KEMATIAN PENDUDUK',
              name=u'label_data_penduduk', parent=self, pos=wx.Point(288, 0),
              size=wx.Size(300, 17), style=0)

        self.daftar = wx.ListCtrl(id=wxID_KEJADIAN_KEMATIANDAFTAR,
        ...
        self.textCtrl1 = wx.TextCtrl(id=wxID_KEJADIAN_KEMATIANTEXTCTRL1,
              name='textCtrl1', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.button1 = wx.Button(id=wxID_KEJADIAN_KEMATIANBUTTON1,
