#Boa:Dialog:otentifikasi_pariwisata
...
def create(parent):
    return otentifikasi_pariwisata(parent)

[wxID_OTENTIFIKASI_PARIWISATA, wxID_OTENTIFIKASI_PARIWISATAINPUT_PASSWORD, 
 wxID_OTENTIFIKASI_PARIWISATALABEL_MASUKAN_PASSWORD, 
 wxID_OTENTIFIKASI_PARIWISATALABEL_PASSWORD, 
 wxID_OTENTIFIKASI_PARIWISATATOMBOL_KEMBALI_KEMENU, 
 wxID_OTENTIFIKASI_PARIWISATATOMBOL_LANJUTKAN, 
] = [wx.NewId() for _init_ctrls in range(6)]

class otentifikasi_pariwisata(wx.Dialog):
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Dialog.__init__(self, id=wxID_OTENTIFIKASI_PARIWISATA,
              name=u'otentifikasi_pariwisata', parent=prnt, pos=wx.Point(515,
              304), size=wx.Size(402, 140), style=wx.CAPTION,
              title=u'Otentifikasi Input Pariwisata')
        self.SetClientSize(wx.Size(402, 140))
        self.Center(wx.BOTH)

        self.label_password = wx.StaticText(id=wxID_OTENTIFIKASI_PARIWISATALABEL_PASSWORD,
              label=u'Password', name=u'label_password', parent=self,
              pos=wx.Point(16, 56), size=wx.Size(64, 24), style=0)

        self.input_password = wx.TextCtrl(id=wxID_OTENTIFIKASI_PARIWISATAINPUT_PASSWORD,
              name=u'input_password', parent=self, pos=wx.Point(96, 56),
              size=wx.Size(296, 25), style=wx.TE_PASSWORD, value='')

        self.label_masukan_password = wx.StaticText(id=wxID_OTENTIFIKASI_PARIWISATALABEL_MASUKAN_PASSWORD,
              label=u'MASUKAN PASSWORD DAHULU', name=u'label_masukan_password',
              parent=self, pos=wx.Point(104, 16), size=wx.Size(203, 17),
              style=0)

        self.tombol_lanjutkan = wx.Button(id=wxID_OTENTIFIKASI_PARIWISATATOMBOL_LANJUTKAN,
        ...
        self.tombol_lanjutkan.Bind(wx.EVT_BUTTON, self.OnTombol_lanjutkanButton,
              id=wxID_OTENTIFIKASI_PARIWISATATOMBOL_LANJUTKAN)

        self.tombol_kembali_kemenu = wx.Button(id=wxID_OTENTIFIKASI_PARIWISATATOMBOL_KEMBALI_KEMENU,
        ...
        self.tombol_kembali_kemenu.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_OTENTIFIKASI_PARIWISATATOMBOL_KEMBALI_KEMENU)
