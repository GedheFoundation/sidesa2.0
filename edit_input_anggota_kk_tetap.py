#Boa:Frame:edit_input_anggota_kk_tetap
...
def create(parent):
    return edit_input_anggota_kk_tetap(parent)

[wxID_EDIT_INPUT_ANGGOTA_KK_TETAP, wxID_EDIT_INPUT_ANGGOTA_KK_TETAPBUTTON1, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_CERAI, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_KEMATIAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_LAHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_NIKAH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_KITAS, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_KTP, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_PASPORT, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_VISA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPDAFTAR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPDOKUMEN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_ALAMAT, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_AYAH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_DUSUN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_IBU, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_NAMA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_NIK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_NO_KK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_TEMPAT_LAHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPKEMBALI, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_AGAMA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_ALAMAT, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DATA_PENDUDUK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DIFABELITAS, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DUSUN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_GOLONGAN_DARAH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_JENIS_KELAMIN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_KEWARGANEGARAAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_KONTRASEPSI, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NAMA_AYAH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NAMA_IBU, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NAMA_LENGKAP, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NOMOR_KK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PEKERJAAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PEKERJAAN_LAINNYA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PENDIDIKAN_TEMPUH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_RESIKO_KEHAMILAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_SHDK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_PERKAWINAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_TINGGAL, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_TANGGAL_LAHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_TEMPAT_LAHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLEBEL_NIK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPHOTO, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_AGAMA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_DIFABELITAS, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_GOLONGAN_DARAH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_JENIS_KELAMIN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_KEHAMILAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_KONTRASEPSI, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PEKERJAAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PEKERJAAN_LAINNYA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PENDIDIKAN_DITEMPUH, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PENDIDIKAN_TERAKHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_SHDK, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS_KEPENDUDUKAN, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS_TINGGAL, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_WARGANEGARA, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHPHOTO, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPSTATICTEXT1, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTANGGAL_LAHIR, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTEXTCTRL1, 
 wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTOMBOL_TAMBAH_DATA, 
] = [wx.NewId() for _init_ctrls in range(67)]

class edit_input_anggota_kk_tetap(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAP,
              name=u'edit_input_anggota_kk_tetap', parent=prnt,
              pos=wx.Point(406, 76), size=wx.Size(888, 639),
              style=wx.FRAME_NO_TASKBAR,
              title=u'Edit Anggota Kartu Keluarga Tetap')
        self.SetClientSize(wx.Size(888, 639))
        self.Center(wx.BOTH)
        

        self.label_nomor_kk = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NOMOR_KK,
              label=u'Nomor KK', name=u'label_nomor_kk', parent=self,
              pos=wx.Point(8, 152), size=wx.Size(168, 17), style=0)

        self.input_no_kk = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_NO_KK,
              name=u'input_no_kk', parent=self, pos=wx.Point(8, 168),
              size=wx.Size(240, 25), style=0, value=u'')

        self.input_alamat = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_ALAMAT,
              name=u'input_alamat', parent=self, pos=wx.Point(272, 168),
              size=wx.Size(288, 25), style=0, value=u'')

        self.input_dusun = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_DUSUN,
              name=u'input_dusun', parent=self, pos=wx.Point(592, 168),
              size=wx.Size(280, 25), style=0, value=u'')

        self.label_alamat = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_ALAMAT,
              label=u'Alamat', name=u'label_alamat', parent=self,
              pos=wx.Point(272, 152), size=wx.Size(47, 17), style=0)

        self.label_dusun = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DUSUN,
        ...
        self.pilihan_golongan_darah = wx.ComboBox(choices=['A', 'AB', 'B', 'O',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_GOLONGAN_DARAH,
              name=u'pilihan_golongan_darah', parent=self, pos=wx.Point(192,
              408), size=wx.Size(80, 25), style=0)

        self.label_agama = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_AGAMA,
        ...
        self.pilihan_agama = wx.ComboBox(choices=['Islam', 'Kristen Protestan',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_AGAMA,
              name=u'pilihan_agama', parent=self, pos=wx.Point(400, 208),
              size=wx.Size(216, 25), style=0)

        self.label_kewarganegaraan = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_KEWARGANEGARAAN,
        ...
        self.pilihan_warganegara = wx.ComboBox(choices=['WNI', 'WNA'],
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_WARGANEGARA,
              name=u'pilihan_warganegara', parent=self, pos=wx.Point(400, 248),
              size=wx.Size(216, 25), style=0)

        self.label_pendidikan_terakhir = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PENDIDIKAN_TERAKHIR,
        ...
        self.pilihan_pendidikan_terakhir = wx.ComboBox(choices=['Tidak / Belum Sekolah',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PENDIDIKAN_TERAKHIR,
              name=u'pilihan_pendidikan_terakhir', parent=self,
              pos=wx.Point(400, 288), size=wx.Size(216, 25), style=0)

        self.label_pendidikan_tempuh = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PENDIDIKAN_TEMPUH,
        ...
        self.pilihan_pendidikan_ditempuh = wx.ComboBox(choices=['PAUD sederajat',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PENDIDIKAN_DITEMPUH,
              name=u'pilihan_pendidikan_ditempuh', parent=self,
              pos=wx.Point(400, 328), size=wx.Size(216, 25), style=0)

        self.label_pekerjaan = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PEKERJAAN,
        ...
        self.pilihan_pekerjaan = wx.ComboBox(choices=['Belum / Tidak Bekerja',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PEKERJAAN,
              name=u'pilihan_pekerjaan', parent=self, pos=wx.Point(400, 370),
              size=wx.Size(216, 25), style=0)

        self.label_pekerjaan_lainnya = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_PEKERJAAN_LAINNYA,
              label=u'Pekerjaan Lainnya', name=u'label_pekerjaan_lainnya',
              parent=self, pos=wx.Point(400, 392), size=wx.Size(168, 17),
              style=0)

        self.label_status_perkawinan = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_PERKAWINAN,
        ...
        self.pilihan_status = wx.ComboBox(choices=['Belum Kawin', 'Kawin'],
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS,
              name=u'pilihan_status', parent=self, pos=wx.Point(624, 208),
              size=wx.Size(248, 25), style=0)

        self.label_status_kependudukan = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_KEPENDUDUKAN,
        ...
        self.pilihan_status_kependudukan = wx.ComboBox(choices=['Penduduk Tetap',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS_KEPENDUDUKAN,
              name=u'pilihan_status_kependudukan', parent=self,
              pos=wx.Point(624, 248), size=wx.Size(248, 25), style=0)

        self.label_status_tinggal = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_STATUS_TINGGAL,
        ...
        self.pilihan_status_tinggal = wx.ComboBox(choices=['Tinggal Tetap',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_STATUS_TINGGAL,
        ...
        self.label_difabelitas = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DIFABELITAS,
        ...
        self.pilihan_difabelitas = wx.ComboBox(choices=['Tidak cacat',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_DIFABELITAS,
        ...
        self.label_kontrasepsi = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_KONTRASEPSI,
        ...
        self.pilihan_kontrasepsi = wx.ComboBox(choices=['Pil', 'Suntik', 'IUD',
              'Kondom', 'Implant', 'MOP'],
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_KONTRASEPSI,
        ...
        self.label_shdk = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_SHDK,
        ...
        self.pilihan_shdk = wx.ComboBox(choices=['Kepala Keluarga', 'Anak',
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_SHDK,
              name=u'pilihan_shdk', parent=self, pos=wx.Point(24, 560),
              size=wx.Size(304, 25), style=0)

        self.label_nama_ayah = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NAMA_AYAH,
              label=u'Nama Ayah', name=u'label_nama_ayah', parent=self,
              pos=wx.Point(344, 536), size=wx.Size(152, 17), style=0)

        self.input_ayah = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_AYAH,
              name=u'input_ayah', parent=self, pos=wx.Point(344, 560),
              size=wx.Size(280, 25), style=0, value=u'')

        self.label_nama_ibu = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_NAMA_IBU,
              label=u'Nama Ibu', name=u'label_nama_ibu', parent=self,
              pos=wx.Point(632, 536), size=wx.Size(160, 17), style=0)

        self.input_ibu = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPINPUT_IBU,
              name=u'input_ibu', parent=self, pos=wx.Point(632, 560),
              size=wx.Size(240, 25), style=0, value=u'')

        self.label_resiko_kehamilan = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_RESIKO_KEHAMILAN,
        ...
        self.pilihan_kehamilan = wx.ComboBox(choices=['Resiko Tinggi',
              'Tidak Resiko Tinggi'],
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_KEHAMILAN,
        ...
        self.pilihan_pekerjaan_lainnya = wx.ComboBox(choices=['Berdagang',
              ...
              'Lainnya'],
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPPILIHAN_PEKERJAAN_LAINNYA,
              name=u'pilihan_pekerjaan_lainnya', parent=self, pos=wx.Point(400,
              408), size=wx.Size(216, 25), style=0)

        self.tanggal_lahir = wx.DatePickerCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTANGGAL_LAHIR,
              name=u'tanggal_lahir', parent=self, pos=wx.Point(192, 368),
              size=wx.Size(200, 26), style=wx.DP_SHOWCENTURY)

        self.tombol_tambah_data = wx.Button(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTOMBOL_TAMBAH_DATA,
        ...
        self.tombol_tambah_data.Bind(wx.EVT_BUTTON,
              ...
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTOMBOL_TAMBAH_DATA)

        self.kembali = wx.Button(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPKEMBALI,
        ...
        self.kembali.Bind(wx.EVT_BUTTON, self.OnKembaliButton,
              id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPKEMBALI)

        self.cek_akta_lahir = wx.CheckBox(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_LAHIR,
        ...
        self.dokumen = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPDOKUMEN,
              label=u'Kepemilikan Dokumen', name=u'dokumen', parent=self,
              pos=wx.Point(24, 440), size=wx.Size(304, 17), style=0)

        self.cek_akta_nikah = wx.CheckBox(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_NIKAH,
        ...
        self.cek_akta_cerai = wx.CheckBox(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_CERAI,
        ...
        self.cek_akta_kematian = wx.CheckBox(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_AKTA_KEMATIAN,
        ...
        self.cek_ktp = wx.CheckBox(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPCEK_KTP,
        ...
        self.label_data_penduduk = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPLABEL_DATA_PENDUDUK,
              label=u'FORM EDIT DATA PENDUDUK', name=u'label_data_penduduk',
              parent=self, pos=wx.Point(336, 0), size=wx.Size(216, 17),
              style=0)

        self.daftar = wx.ListCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPDAFTAR,
        ...
        self.staticText1 = wx.StaticText(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPSTATICTEXT1,
              label=u'Nama Penduduk', name='staticText1', parent=self,
              pos=wx.Point(400, 128), size=wx.Size(145, 15), style=0)

        self.textCtrl1 = wx.TextCtrl(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPTEXTCTRL1,
              name='textCtrl1', parent=self, pos=wx.Point(552, 128),
              size=wx.Size(224, 24), style=0, value='')

        self.button1 = wx.Button(id=wxID_EDIT_INPUT_ANGGOTA_KK_TETAPBUTTON1,
